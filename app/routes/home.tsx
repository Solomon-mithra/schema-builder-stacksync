    ...
    <div className="min-h-screen text-gray-900">
      <div className="container mx-auto p-4 pt-10 pb-10">
        ...
        <p className="mb-6 text-gray-600">
          Use the Schema Builder to visually create and manage your schema for
          Connector Modules.
        </p>
        <div className="flex border-b border-gray-300 dark:border-gray-700">
          <button
            className={`px-4 py-2 text-lg font-medium flex items-center cursor-pointer transition-all duration-200 ease-in-out ${
              activeTab === "builder"
